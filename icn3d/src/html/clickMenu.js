...
class ClickMenu {
    ...
    //    clkMn1_pdbid: function() {
      ...
      //container.innerHTML = `
      <link rel="stylesheet" href="elect_pathways.css">
        <style>
          .custom-input {
            width: 200px;
            padding: 10px;
        ...
        <div id="form-container">
          ...
          <form action="..\\..\\..\\php\\input_pdb_file.php" target="_self" method="POST" enctype="multipart/form-data">
            <label for="name">Enter name of project:</label>
            <input type="text" name="name" id="name" placeholder="Name" style="font-size: 13px;" class="custom-input">
            ...
            <label for="atom1">Enter donor:</label>
            <input type="text" name="atom1" id="atom1" placeholder="Donor" style="font-size: 13px;" class="custom-input">
            <span id="atom1-error"></span>
      
            <label for="atom2">Enter acceptor:</label>
            <input type="text" name="atom2" id="atom2" placeholder="Acceptor" style="font-size: 13px;" class="custom-input">
    ...
    function dragElement(elmnt) {
      ...
      function dragMouseDown(e) {
        if (e.target.tagName.toLowerCase() === "input") {
          // If the click occurs on an input field, do not initiate dragging
          return;
        }
      ...
      function closeDragElement() {
        ...
        isDragging = false; // Reset dragging state to false
      ...
      // Append the container to a parent element in the HTML document
